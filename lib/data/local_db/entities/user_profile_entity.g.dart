...
extension UserProfileEntityByIndex on IsarCollection<UserProfileEntity> {
  Future<UserProfileEntity?> getByKey(String key) {
    return getByIndex(r'key', [key]);
  }

  UserProfileEntity? getByKeySync(String key) {
  ...
  Future<List<UserProfileEntity?>> getAllByKey(List<String> keyValues) {
    final values = keyValues.map((e) => [e]).toList();
    return getAllByIndex(r'key', values);
  }

  List<UserProfileEntity?> getAllByKeySync(List<String> keyValues) {
    final values = keyValues.map((e) => [e]).toList();
  ...
  Future<Id> putByKey(UserProfileEntity object) {
    return putByIndex(r'key', object);
  }

  Id putByKeySync(UserProfileEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'key', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByKey(List<UserProfileEntity> objects) {
...
extension UserProfileEntityQuerySortBy
  ...
  QueryBuilder<UserProfileEntity, UserProfileEntity, QAfterSortBy> sortByKey() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileEntityQuerySortThenBy
  ...
  QueryBuilder<UserProfileEntity, UserProfileEntity, QAfterSortBy> thenByKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'key', Sort.asc);
    });
  }
...
extension UserProfileEntityQueryWhereDistinct
  ...
  QueryBuilder<UserProfileEntity, UserProfileEntity, QDistinct> distinctByKey({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileEntityQueryProperty
  ...
  QueryBuilder<UserProfileEntity, String, QQueryOperations> keyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'key');
    });
  }

  QueryBuilder<UserProfileEntity, String, QQueryOperations> valueProperty() {
    return QueryBuilder.apply(this, (query) {
